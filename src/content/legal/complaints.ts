...
export const complaintsPage: LegalPage = {
  slug: "complaints",
...
:::infobox[blue] Complaints About Your Solicitor
...
Our complaints procedure complies with FCA requirements set out in the Dispute Resolution: Complaints (DISP) sourcebook.
